...
Known gaps and unscheduled work for Minesweeper. The slug naming rules, and the
rule that an entry is deleted as it lands rather than marked done, are repo-wide
and live in the root `TODO.md`.
